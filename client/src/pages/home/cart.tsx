...
export default function Cart() {
  return (
    <Layout>
      <div className="mx-auto max-w-2xl px-8 py-8 sm:px-6 lg:max-w-7xl lg:px-8">
                  ...
                  <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                    <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                      ...
                      <div className="mt-4 sm:mt-0 sm:pr-9">
                        ...
                        <select id={`quantity-${productIdx}`} name={`quantity-${productIdx}`} className="max-w-full rounded-md border border-gray-300 py-1.5 text-left text-base font-medium leading-5 text-gray-700 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm">
                    ...
                    <p className="mt-4 flex space-x-2 text-sm text-gray-700">
                      {product.inStock ? <CheckIcon className="h-5 w-5 flex-shrink-0 text-green-500" aria-hidden="true" /> : <ClockIcon className="h-5 w-5 flex-shrink-0 text-gray-300" aria-hidden="true" />}
